...
import { colorSchemes } from "./ThemeProvider";
...
export function Settings({ isCollapsed = false }: SettingsProps) {
                        ...
                        <div className="flex items-center space-x-3">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-muted-foreground">
                              Customize your TheraSage experience
                            </p>
                          </div>
                        </div>
                        <Button
